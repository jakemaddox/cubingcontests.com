    ...
    <>
      ...
      <div className="mt-4">
        ...
        <p className="ms-3">
          ...
          locations, you must instead use the <b className="hl">Competition</b> contest type. The name must be set like
          this: [WCA competition name without the year] ([Location]) [Year] (e.g. FMC (Prague) 2024). The short name can
          be reasonably chosen, as long as it contains most of the same information. The contest ID must match the full
          CC contest name. The description must include links to both the WCA page and the location website (if
          applicable) at the top, using this Markdown template:
        </p>
        <div className="alert alert-light mx-3" role="alert">
          Unofficial events from <strong>WCA COMPETITION NAME</strong> (location <strong>LOCATION</strong>). For
          official events see the official [WCA competition page](link to WCA page). For information about this location
          see [the location page](link to location website).
        </div>
        <p>
        ...
        <p>
          ...
          is approved without direct admin intervention. As such, changing formats is <b>highly</b> discouraged. You may
          add additional rounds after the contest is approved yourself if you have the time for it, but adding an event
          requires admin approval. If you would like to hold a brand <b>new event</b>, you may request for it to be
          added, but this should be done before your contest is approved.
        </p>
        <p>
...
export default ModeratorInstructionsWca;
